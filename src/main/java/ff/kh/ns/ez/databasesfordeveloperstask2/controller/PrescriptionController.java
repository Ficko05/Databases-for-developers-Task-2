...
//    public List<Prescriptions> getAllPrescriptionsWithCurrentDate(@PathVariable("reminder_date") @DateTimeFormat(pattern = "yyyy-MM-dd") Date reminder_date){
    ...
    public List<Prescriptions> getAllPrescriptionsWithCurrentDate(@PathVariable("reminder_date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate reminder_date){
